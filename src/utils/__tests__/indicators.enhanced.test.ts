...
describe('Enhanced Indicators Analysis', () => {
  ...
  describe('analyzeIndicators', () => {
    ...
    it('should calculate Bollinger Bands correctly', () => {
      ...
      expect(analysis.bollingerBands.middle).toBeGreaterThan(
    ...
    it('should calculate Volume Profile correctly', () => {
      ...
      expect(analysis.volumeProfile.valueAreaHigh).toBeGreaterThanOrEqual(
        analysis.volumeProfile.valueAreaLow
      )
    })
