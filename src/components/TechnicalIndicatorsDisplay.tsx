  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <div
          className={`px-3 py-1 rounded-full text-xs font-medium ${getSignalColor(analysis?.signals?.overall || 'neutral')}`}
        >
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                ...
                <div
                  className={`text-xs ${getSignalColor(analysis?.signals?.rsi || 'neutral')}`}
                >
              ...
              <>
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    ...
                    <div
                      className={`text-xs ${getSignalColor(analysis?.signals?.macd || 'neutral')}`}
                    >
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  <div
                    className={`text-xs ${getSignalColor(analysis?.signals?.bollinger || 'neutral')}`}
                  >
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  ...
                  <div
                    className={`text-xs ${getSignalColor(analysis.signals?.stochRSI || 'neutral')}`}
                  >
            ...
            {analysis?.volumeProfile &&
              analysis?.volumeProfile?.levels?.length > 0 && (
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600 dark:text-gray-400">
                      Volume POC
