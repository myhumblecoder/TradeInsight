  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {user.email && (
          <span className={isDark ? 'text-gray-500' : 'text-gray-500'}>{user.email}</span>
        )}
        <svg
      ...
      {isOpen && (
        <div className={`absolute right-0 mt-2 w-48 rounded-md shadow-lg ring-1 ring-opacity-5 border z-50 ${
          isDark
          ...
          <div className="py-1">
            <div className={`px-4 py-2 text-sm border-b ${
              ...
              <div className={isDark ? 'text-gray-400' : 'text-gray-500'}>{user.email}</div>
            </div>
            <button
