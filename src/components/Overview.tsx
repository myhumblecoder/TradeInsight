...
export function Overview() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors flex items-center justify-center">
      <div className="text-gray-900 dark:text-white">Loading top cryptocurrencies...</div>
    </div>
  )
          ...
          {cryptos.map((crypto) => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{cryptoDisplayNames[crypto.id] || crypto.name}</h3>
